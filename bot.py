...
if __name__ == "__main__":
    ...
    bot.mongo = motor.motor_asyncio.AsyncIOMotorClient(str(bot.connection_url),tls=True, tlsAllowInvalidCertificates=True)
    bot.db = bot.mongo["botdb"]
